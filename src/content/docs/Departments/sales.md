...
As described in [onboarding](https://handbook.shorebird.dev/company/onboarding/)
we use Google Workspace for our Email & Calendar. This allows you to use any
other services and/or apps that you typically would to stay organized.
...
While at some point in the future we will more then likely build workflows that
...
If you have a need for a coupon code reach out to the Operations team in order
to get the details.
